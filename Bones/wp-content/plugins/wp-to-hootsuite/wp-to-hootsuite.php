...
class WP_To_Hootsuite {
    ...
    public function __construct() {
        ...
        $this->plugin->version          = '1.1.8';
        $this->plugin->buildDate        = '2019-10-03 18:00:00';
        $this->plugin->requires         = 3.6;
        $this->plugin->tested           = '5.2.3';
        ...
        $this->plugin->upgrade_reasons = array(
            array(
                __( 'Instagram and Pinterest Support', $this->plugin->name ), 
                __( 'Post to Instagram (Personal Profiles only) and Pinterest Boards', $this->plugin->name ),
            ),
            array(
            ...
            array(
                ...
                __( 'Each status update can be posted immediately or scheduled at a specific time', $this->plugin->name ),
            ),
            array(
            ...
            array(
                ...
                __( 'Schedule Posts to Hootsuite based on your Event\'s Start or End date, as well as display Event-specific details in your status updates', $this->plugin->name ),
            ),
            array(
